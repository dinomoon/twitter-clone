...
const StyledNweetForm = styled.div`
  display: flex;
  padding: 10px 16px;
  ${(props) =>
    props.modal &&
      ...
      <div className="right">
        <div className="top">
          <textarea
            ...
            value={nweet}
            onChange={(e) => handleNweetChange(e)}
            onKeyDown={(e) => handleResizeTextArea(e)}
            onKeyUp={(e) => handleResizeTextArea(e)}
          />
        </div>
        {attachment && (
          <div className="attachment">
            <img src={attachment} alt="" className="nweet-img" />
            <div className="svg-wrapper" onClick={handleAttachment}>
